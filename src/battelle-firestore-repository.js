...
export function fromFirestoreDocument(id,data){
  ...
  const record=sanitizeRecord({...data,id,createdAt:timestampToIso(data.createdAt),updatedAt:timestampToIso(data.updatedAt)});
