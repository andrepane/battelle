...
async function renderHome(preloaded=null){
  ...
  host.replaceChildren(renderTable(state.trashMode?['Paciente','Terapeuta','Evaluación','Estado anterior','Eliminada','Usuario','Acciones']:['Paciente','Terapeuta','Nacimiento','Evaluación','Edad','Estado','Última modificación','Acciones'],rows,'assessments-table'));
}
